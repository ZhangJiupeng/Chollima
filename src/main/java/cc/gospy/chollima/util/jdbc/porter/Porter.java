...
package cc.gospy.chollima.util.jdbc.porter;

import cc.gospy.chollima.util.jdbc.porter.annotation.Entity;
import cc.gospy.chollima.util.jdbc.porter.annotation.Ignore;
import cc.gospy.chollima.util.jdbc.porter.except.IllegalBeanEntityException;
...
public class Porter {
    ...
    private static <T> Map<String, Object> getParametersPair(T t) throws IllegalBeanEntityException {
        ...
        for (Method method : t.getClass().getDeclaredMethods()) {
            ...
            if (method.getName().startsWith("select") && method.getReturnType() != void.class) {
                try {
