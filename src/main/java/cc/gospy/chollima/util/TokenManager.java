...
public final class TokenManager {
     ...
     */
    private static final long lifeCycle = 1200000; // ms
    ...
    public synchronized static String createToken(String identityStr) {
        ...
        String newToken = Hashing.md5()
                .hashString(timestamp.concat(identityStr), Charset.defaultCharset())
                .toString();
...
//            System.err.println("Token not exists. (" + oldToken + ")");
    ...
    public static void deleteIfExist(String token) {
        tokenBuffer.remove(token);
    }
